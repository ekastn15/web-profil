...
<div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center py-5">
        <h1 class="section-heading text-uppercase text-white">Lainnya</h1>
        </nav>
    </div>
</div>
<section class="page-section bg-light" id="team-container">
    <div class="row justify-content-center"">
        ...
        <div class=" col-lg-4 col-md-6 col-sm-12 mb-4 pegawai-item">
...
<script>
    $(document).ready(function () {
        var itemsPerPage = 6;
        var totalItems = $(".pegawai-item").length;
        ...
        function showPage(page) {
            ...
            $(".pegawai-item").slice(start, end).show();
